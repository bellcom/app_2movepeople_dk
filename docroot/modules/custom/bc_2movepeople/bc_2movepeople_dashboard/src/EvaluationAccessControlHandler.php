 ...
 *
 * @see \Drupal\bc_2movepeople_dashboard\Entity\Evaluation.
 */
class EvaluationAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\bc_2movepeople_dashboard\Entity\EvaluationInterface $entity */
