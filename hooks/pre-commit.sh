...
PHPCS_BIN=$(git rev-parse --show-toplevel)/bin/phpcs
...
PHPCS_FILE_PATTERN="\.(php|module|inc|install|test|profile|theme|css|info|txt|md)$"
...
# parse config to override config values
CONFIG_FILE=$(git rev-parse --show-toplevel)/hooks/config
